...
|---|---|---|---|---|---|
| [Bodlun & Kullgren (1996)](https://doi.org/10.1007/BF02438167) | Swedish clinical sample of 10 trans women and 9 trans men, "core transsexuals" | changes in well-being from medical transition (in general) over 5 year period, used questionnaire | 5 years, transition stages differed between participants and some have still not medically transitioned to the extent that they wish by the end of the 5 year period | 13 improved, 3 stable, 2 unsatisifed, 1 unsatisifed & detranstioned |  |
